   ...
   <div class="d-flex" id="wrapper">
     ...
     <div class="bg-light border-right" id="sidebar-wrapper">
       ...
       <div class="list-group list-group-flush margin-top10">
         ...
         <a href="{{url('/residence/view')}}" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-windows"> Residence</i>
         </a>

         <a href="{{url('/register/staff')}}" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-users"> Register</i>
         </a>
